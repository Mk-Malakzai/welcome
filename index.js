...
const token = process.env.8393105551:AAH0FQWc71dv2xu4YfGDM9ZElEDd5ZvyZCY;

// Web App ka URL (Vercel/Netlify se milega)
const webAppUrl = 'https://gameearnmoney1.blogspot.com/; // <-- Yahan Web App ka URL daalein

// Community ka URL
const communityUrl = 'https://t.me/Mk_Malakzaikhan'; // <-- Yahan Community ka URL daalein
